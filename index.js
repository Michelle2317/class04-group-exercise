 ...
 * initialis9e the variable `bag two` to the value of 12
...
/**
 * Initialise the variable x to the value 1. Add the incrementing operator right after. Then
console log x. Write the display output using a single line comment
 */
var x = 1;
x++;
console.log(x); //2
...
/**
 * initialise the variable 'candyOne' to the value of 2
 * initialise the variable 'candyTwo' to the value of 4
 * initialise the variable 'candyThree' to the value of 8
 * initialise total to the average of candyOne, candyTwo and candyThree
 * console log the total and only show 2 decimal places using the .toFixed method. Write a single line comment as to what will be displayed
 */
var candyOne = 2;
var candyTwo = 4;
...
/**
 * initialise the variable 'flowerOne' to the value of 2
 * initialise the variable 'flowerTwo' to the value of 4
 * initialise the variable 'flowerThree' to the value of 8
 * initialise the variable 'flowerFour' to the value of 12
 * initialise total to the average of flowerOne, flowerTwo, flowerThree and flowerFour
 * console log the total and only show 3 decimal places using the .toFixed method. Write a single line comment as to what will be displayed
 */
var flowerOne = 2;
var flowerTwo = 4;
var flowerThree = 8;
var flowerFour = 12;
var total = (flowerOne + flowerTwo + flowerThree + flowerFour) / 4;
console.log(total.toFixed(3)); // 6.500